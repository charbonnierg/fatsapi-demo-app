...
class AppContainer(typing.Generic[SettingsT]):
    ...
    settings: SettingsT = dataclasses.field(default_factory=BaseAppSettings)
    # Configuration file
    ...
    hooks: typing.List[
        typing.Callable[
            [AppContainer], typing.Optional[typing.AsyncContextManager[typing.Any]]
        ]
    ] = dataclasses.field(default_factory=list)
    # Tasks
    tasks: typing.List[
        typing.Union[
            typing.Callable[
                [AppContainer], typing.Coroutine[typing.Any, typing.Any, typing.Any]
            ],
            AppTask[typing.Any],
