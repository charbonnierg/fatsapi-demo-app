...
class OIDCAuthProvider:
    ...
    def __load_public_key__(self) -> None:
        ...
        for jwk in jwks["keys"]:
            ...
            raise Exception(f"OpenID Connect issuer does not support any of the accepted algorithms: {self.algorithms}")
        # Load public key
...
class OIDCAuth(SecurityBase, metaclass=Singleton):
    ...
    def update_model(cls, provider: OIDCAuthProvider) -> None:
        ...
        auth.model.openIdConnectUrl = provider.issuer_url
